...
public class ProducerConfigFactory<K,V> {
	...
	/**
	 * Order Status ProducerFactory
	 * @return ProducerFactory<E,V>
	 */
	public ProducerFactory<K, V> createOrderStatusProducerFactory(){
		Map<String, Object> config = new HashMap<>();
	...
	/**
	 * Order Status KafkaTemplate
	 * @return KafkaTemplate<E,V>
	 */
	public KafkaTemplate<K, V> createOrderStatuskafkaTemplate() {
        return new KafkaTemplate<>(createOrderStatusProducerFactory());
    }
